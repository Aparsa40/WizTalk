    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#12091f] text-amber-300">
        <div className="text-center">
          <div className="mx-auto mb-4 h-12 w-12 animate-spin rounded-full border-4 border-amber-300 border-t-transparent" />
  ...
  if (error) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#12091f] p-6 text-amber-50">
        <div className="max-w-md rounded-3xl border border-rose-300/20 bg-rose-500/10 p-8 text-center">
          ...
          <button
            ...
            className="mt-6 rounded-xl bg-amber-500 px-5 py-3 font-bold text-[#21102e]"
          >
            تلاش دوباره
          </button>
        ...
        <CharacterSelector
          ...
          onSelect={(character) =>
            updateAppState({
              ...
              provider:
                CharacterService.defaultProvider(
                  character,
                ),

              model:
                character.textModels.default.model,
            })
          }
          onManage={() =>
            setShowSettings(true)
